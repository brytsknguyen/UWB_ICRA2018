...
flightdata = csvread('bagcsv/niv20170821_N.csv', 1, 0);
...
anihd = figure('name', '3D Pos', 'position', [865 200 480 800], 'color', [1 1 1]);
hold on;
...
xlim([-2, 1]);
ylim([-2.125, 2.8]);
ylb = ylabel('$\mathrm{Position}\ y\ [m]$', 'interpreter', 'latex');
...
set(lghd, 'interpreter', 'latex', 'fontsize', 12, 'position', [0.333 0.773 0.368 0.1]);
grid on;
