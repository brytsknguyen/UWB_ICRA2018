...
figure('name', '3D Pos', 'position', [865 200 800 600], 'color', [1 1 1]);
view([-22.8, 10.8]);
hold on;
...
set(gca, 'DataAspectRatio', [1 1 1], 'fontsize', 14, 'Fontname', 'cambria math');
xlim([-2.5, 2.5]);
ylim([-2.5, 2.5]);
zlim([0, 2]);
...
figure('name', 'Position','position', [1278 100 800 600], 'color', [1 1 1]);
subplot(3, 1, 1);
...
set(gca, 'fontsize', 16, 'Fontname', 'cambria math');  
grid on;
...
figure('name', 'Velocity','position', [1278 100 800 600], 'color', [1 1 1]);
subplot(3, 1, 1);
...
figure('name', 'Pos. Err', 'position', [2626 64 800 600]);
